...
extern const uint8_t _binary_kmod_ko_start[];
extern const uint8_t _binary_kmod_ko_end[];
extern const uint8_t _binary_kmod_ko_size;
...
extern int __x64_sys_delete_module(const char *name_user, unsigned int flags);

extern int __x64_sys_getpid(void);
