...
[[ -n $PERF ]] && PERF="perf record -F 99 -a -g --"
echo "RUNNING: sudo $PERF $GDB $LD_DEBUG $KLD_DEBUG $VALKEYSERVER $VALKEYCONFIG $VALKEYARGS" > /dev/stderr

sudo $PERF $GDB $LD_DEBUG $KLD_DEBUG $VALKEYSERVER $VALKEYCONFIG $VALKEYARGS
